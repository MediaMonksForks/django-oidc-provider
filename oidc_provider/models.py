...
JWT_ALGS = [("HS256", "HS256"), ("RS256", "RS256")]
...
class BaseCodeTokenModel(models.Model):
    ...
    client = models.ForeignKey(
        Client, verbose_name=_(u"Client"), on_delete=models.CASCADE
    )
...
class Code(BaseCodeTokenModel):
    ...
    nonce = models.CharField(
        max_length=255, blank=True, default="", verbose_name=_(u"Nonce")
    )
